...
@ControllerAdvice // 전역 단위 예외처리 활성화 어노테이션
public class ExceptionController {
	
	// @ExceptionHandler ( 예외종류 ) : 어떤 에러를 다룰건지 작성
	
	// 예외종류 : 메서드별로 처리할 예외를 지정
	// SQLException.class - SQL 관련 예외만 처리
	// IOException.class - 입출력 관련 예외만 처리
	// NoResourceFoundException.class - 요청 주소를 찾을 수 없을때 예외처리
 ...
 * 
 * 500 : 서버 내부 오류 ( Internel Server Error ) 
 *  
 */