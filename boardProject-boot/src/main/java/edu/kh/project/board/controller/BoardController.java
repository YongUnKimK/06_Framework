...
public class BoardController {
	 ...
	 * 게시글 목록 조회
	 * 
	 * @param boardCode : 게시판 종류 구분 번호 ( PathVariable로 구해옴 )
	 * @param cp        : 현재 조회를 요청한 페이지 번호 ( 없으면 1 )
	 * @param paramMap  : 검색할떄 추가 (제출된 파라미터가 모두 저장된 map - 검색시 key, query담김)
	 * @return
	 * 
	 *         {boardCode} board/** /board 이하 1레벨 자리에 어떤 주소값이 들어오든 모두 이 메서드 매핑
	 * 
